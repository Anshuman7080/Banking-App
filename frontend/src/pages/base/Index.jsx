...
import { UserProfile } from "../../lib/operations/userApis";
import { logout } from "../../lib/operations/authApis";
                    ...
                    <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
                                            ...
                                            <div>
                        {
                            ...
                            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
                                ...
                                className="inline-flex items-center justify-center cursor-pointer rounded-2xl border border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm transition hover:bg-gray-50 dark:border-white/10 dark:bg-transparent dark:text-white dark:hover:bg-white/5"
                                >
                                Logout
                                </button>
